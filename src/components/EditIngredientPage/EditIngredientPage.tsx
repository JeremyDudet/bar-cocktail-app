...
import { IngredientForm, IngredientListFilters, DeleteConfirmation } from '..';
      ...
      <Container>
        <InfoRow>
          ...
          <InfoColumn>
            ...
            <IngredientList
              handleSelectedIngredient={handleSetSelectedIngredient}
          ...
          <InfoColumn>
            {selectedIngredient ? (
              <InnerInfoColumn>
                <CancelButton onClick={() => setSelectedIngredient()}>
                  CANCEL EDIT
                </CancelButton>
                <DeleteButton onClick={handleSetDisplayDeleteConfirmation}>
                  Delete Ingredient
                </DeleteButton>
                <IngredientForm
